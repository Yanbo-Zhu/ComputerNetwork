...
- Link Layer regelt die physische und logische Kommunikation innerhalb eines lokalen Netzwerks und befasst sich mit der Übertragung von Datenrahmen (Frames) über die physische Verbindung.
...
- [Ethernet](https://en.wikipedia.org/wiki/Ethernet#Evolution): Standard für kabelgebundene lokale Netzwerke
- [Address Resolution Protocol](https://en.wikipedia.org/wiki/Address_Resolution_Protocol) übersetzt IP-Adressen in physische MAC-Adressen.
- [Digital subscriber line](https://en.wikipedia.org/wiki/Digital_subscriber_line) bietet schnellen Internetzugang über Telefonleitungen.
- [ISDN](https://en.wikipedia.org/wiki/ISDN) ermöglicht digitale Datenübertragung über das Telefonnetz.


Network Layer
- ist für die Weiterleitung von Datenpaketen über verschiedene Netzwerke hinweg verantwortlich, einschließlich Adressierung und Routing.
...
- [Internet Protocol](https://en.wikipedia.org/wiki/Internet_Protocol): verantwortlich für die Adressierung und das Routing von Datenpaketen
- [Internet Control Message Protocol](https://en.wikipedia.org/wiki/Internet_Control_Message_Protocol) diagnostiziert Netzwerkprobleme.
- [Internet Group Management Protocol](https://en.wikipedia.org/wiki/Internet_Group_Management_Protocol) unterstützt die Verwaltung von Multicast-Gruppen in Netzwerken.


Transport Layer
- Transport Layer gewährleistet eine zuverlässige, schnelle Übertragung von Daten zwischen Endsystemen und kümmert sich um Fehlerkontrolle, Datenflusssteuerung und Verbindungen.
...
Application Layer
- Application Layer bietet die Schnittstelle zwischen Netzwerk und Anwendungen und definiert Protokolle für spezifische Datenübertragungsaufgaben (z. B. Webzugriff, E-Mails).
...
- Beispiele: **_HyperText Transfer Protocol_** (_**HTTP**_), _**File Transfer Protocol**_ (_**FTP**_), _**Simple Mail Transfer Protocol**_ (_**SMTP**_), _**Domain Name System**_ (_**DNS**_)
    - [HTTPS](https://en.wikipedia.org/wiki/HTTPS) überträgt Webseiteninhalte im Internet.
    - [File Transfer Protocol](https://en.wikipedia.org/wiki/File_Transfer_Protocol) ermöglicht Dateiübertragungen zwischen Geräten.
    - [Simple Mail Transfer Protocol](https://en.wikipedia.org/wiki/Simple_Mail_Transfer_Protocol): zuständig für das Senden von E-Mails
    - [Internet Message Access Protocol](https://en.wikipedia.org/wiki/Internet_Message_Access_Protocol) ermöglicht das Abrufen und Verwalten von E-Mails auf dem Server.
