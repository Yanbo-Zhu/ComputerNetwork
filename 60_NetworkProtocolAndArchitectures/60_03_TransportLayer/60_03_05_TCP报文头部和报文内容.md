...
## 4.2 建立tcp连接: 三次握手Three-way Handshake
...
## 4.3 关闭tcp连接: 四次握手Four-way Handshake 
...
## 4.4 连接复位 Resetting a connection
...
## 4.6 包碎片注意A Note About Packet Fragmentation
