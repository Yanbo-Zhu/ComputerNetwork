...
## 2.2 建立tcp连接: 三次握手Three-way Handshake
...
## 2.4 关闭tcp连接: 四次握手Four-way Handshake 
...
## 2.5 连接复位 Resetting a connection
...
## 2.7 包碎片注意A Note About Packet Fragmentation
